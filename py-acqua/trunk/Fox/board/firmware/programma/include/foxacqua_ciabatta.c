...
int prese_nomi[7][10];//7 nomi da 10 caratterri


//99 sar� il valore x far capire ke quell'ora nn � attiva la sveglia
int presa_timer[7][10][2];// 7 prese x 10 eventi l'una x [0]ora e [1]min
int presa_timer_stato[7][10];// stato di 7 prese x 10 eventi al momento del match tra rtc e tempo qui impostato.
