...
def test():
    ...
    print '.',
    r = ReadBitsResponseBase(13)
    r.bits[0] = True
    r.bits[7] = True
    r.bits[8] = True
    assert r.encodeData() == struct.pack('BB', 129, 1)
    print '.',
    r = ReadBitsResponseBase(8)
    r.bits[0] = True
    r.bits[7] = True
    assert r.encodeData() == struct.pack('B', 129)
    print '.',
    r = ReadBitsResponseBase(16)
    r.bits[0] = True
    r.bits[7] = True
    r.bits[15] = True
    assert r.encodeData() == struct.pack('BB', 129, 128)
    print '.',
