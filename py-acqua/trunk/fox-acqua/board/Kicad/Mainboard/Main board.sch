...
LIBS:power,diode,con-amp-quick,national,aggiunte,device,conn,linear,regul,74xx,cmos4000,adc-dac,memory,xilinx,special,microcontrollers,dsp,microchip,analog_switches,motorola,texas,intel,audio,interface,digital-audio,philips,display,cypress,siliconi,contrib,valves,./Main board.cache
EELAYER 23  0
EELAYER END
$Descr A4 11700 8267
Sheet 1 1
...
U 1 1 4793147B
P 1600 3550
F 0 "R8" V 1680 3550 50  0000 C C
F 1 "R" V 1600 3550 50  0000 C C
	1    1600 3550
	1    0    0    -1  
$EndComp
Text Label 8950 5000 0    60   ~
GND
$Comp
L CR2032_FH-LF BATT1
U 1 1 4787EA58
P 8150 4650
F 0 "BATT1" H 8800 4400 60  0000 C C
F 1 "CR2032" H 9050 4500 60  0000 C C
	1    8150 4650
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 4776769D
P 3550 6350
F 0 "R6" V 3630 6350 50  0000 C C
F 1 "1k" V 3550 6350 50  0000 C C
	1    3550 6350
	0    1    1    0   
$EndComp
$Comp
...
U 1 1 47767696
P 4200 6600
F 0 "R7" V 4280 6600 50  0000 C C
F 1 "3k" V 4200 6600 50  0000 C C
	1    4200 6600
	0    1    1    0   
$EndComp
$Comp
...
U 1 1 4776768D
P 4250 6450
F 0 "C7" H 4250 6450 60  0000 C C
F 1 "4,7nF" H 4250 6450 60  0000 C C
	1    4250 6450
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 47630809
P 2300 6950
F 0 "D4" H 2200 6950 60  0000 C C
F 1 "TRANSZORB_SMD" H 1850 6800 60  0000 C C
	1    2300 6950
	1    0    0    -1  
$EndComp
Kmarq B 3850 5350 "Attenzione: il pin BiDi non è connesso" F=1
Kmarq B 5150 3300 "Warning Pin power_in not driven (Net 22)" F=1
Kmarq B 5150 3100 "Warning Pin power_in not driven (Net 21)" F=1
Kmarq B 5600 3650 "Warning Pin power_in not driven (Net 19)" F=1
Kmarq B 2350 1650 "Warning Pin power_in not driven (Net 6)" F=1
Kmarq B 2350 2400 "Errore: pin power_out connesso al pin power_out (net 4)" F=2
Kmarq B 2350 2600 "Errore: pin power_out connesso al pin power_out (net 4)" F=2
Kmarq B 5800 5900 "Errore: pin power_out connesso al pin power_out (net 4)" F=2
Kmarq B 5700 5900 "Errore: pin power_out connesso al pin power_out (net 4)" F=2
Kmarq B 5150 3200 "Warning Pin power_in not driven (Net 2)" F=1
Kmarq B 5500 3650 "Warning Pin power_in not driven (Net 1)" F=1
$Comp
L M02 SL3
U 1 1 47532E91
P 7150 4000
...
F 1 "P82B96TD" H 4800 1800 60  0000 C C
	...
	1    0    0    -1  
$EndComp
Text Label 1750 3900 0    60   ~
RTC-SCL
Text Label 1750 3800 0    60   ~
RTC-SDA
Text Label 4650 4400 0    60   ~
RTC-SDA
Text Label 4650 4200 0    60   ~
RTC-SCL
Text Label 4650 4300 0    60   ~
RTC-RST
Text Label 4150 5250 0    60   ~
RTC-RST
$Comp
L 1N4004 D2
U 1 1 474BF118
...
F 1 "1N5820" H 2050 6750 50  0000 L B
...
F 1 "DS1302" H 5000 4850 60  0000 C C
	...
	1    0    0    -1  
$EndComp
Text Label 4150 5750 0    60   ~
CS
Text Label 4150 5650 0    60   ~
DI
Text Label 4150 5450 0    60   ~
CLK
Text Label 4150 5550 0    60   ~
DO
Text Label 4750 5750 0    60   ~
CLK
Text Label 4750 5650 0    60   ~
DI
Text Label 4750 5550 0    60   ~
DO
Text Label 4750 5450 0    60   ~
CS
Text Label 5950 6100 0    60   ~
3V3
Text Label 5950 6000 0    60   ~
GND
$Comp
L SD CONN1
U 1 1 474BECAF
...
U 1 1 474BE7A1
P 5700 7100
F 0 "SL1" H 5500 7430 50  0000 L B
F 1 "M04" H 5500 6800 50  0000 L B
F 2 "con-amp-quick-04P" H 5700 7250 50  0001 C C
	1    5700 7100
	-1   0    0    1   
$EndComp
$Comp
...
U 1 1 474BE6E8
P 4200 6750
F 0 "L1" V 4150 6750 40  0000 C C
F 1 "3631B330LL" V 4300 6750 40  0000 C C
	1    4200 6750
	0    -1   -1   0   
$EndComp
$Comp
...
U 1 1 474BD8A7
P 4850 6950
F 0 "C4" H 4900 7050 50  0000 L C
F 1 "220uF" H 4900 6850 50  0000 L C
	1    4850 6950
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 474BD89D
P 2650 6900
F 0 "C2" H 2700 7000 50  0000 L C
F 1 "1000uF" H 2700 6800 50  0000 L C
	1    2650 6900
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 474BD436
P 2400 6900
F 0 "C1" V 2850 6850 60  0000 C C
F 1 "100nF" V 2750 6950 60  0000 C C
	1    2400 6900
	0    1    1    0   
$EndComp
Text Label 2050 2400 0    60   ~
GND
Text Label 2050 1950 0    60   ~
3V3
$Comp
L FOXBOARD U1
U 1 1 474B1CE4
