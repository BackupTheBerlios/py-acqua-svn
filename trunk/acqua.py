...
if not os.path.exists("Data/db"):
	...
	cursore.execute("create table vasca(id integer, vasca TEXT, date DATE, nome TEXT, litri TEXT, tipo TEXT, filtro TEXT, co TEXT, illuminazione TEXT, riscaldamento TEXT, img TEXT)")
